...
static inline size_t stringbuffer_get_length(const StringBuffer *const buffer)
{
  assert(buffer != NULL);
...
static inline char *stringbuffer_get_pointer(const StringBuffer *const buffer)
{
  assert(buffer != NULL);
