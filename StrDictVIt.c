...
void *strdictviter_init(StrDictVIter *const iter, StrDict *const dict,
...
void *strdictviter_all_init(StrDictVIter *const iter,
                            StrDict *const dict)
{
  assert(iter);
  assert(dict);
...
void *strdictviter_advance(StrDictVIter *const iter)
{
  assert(iter);
  assert(iter->dict);
